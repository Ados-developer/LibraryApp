...
namespace LibraryApp.UI
{
    public class LogoutButton : IconButton
    {
        ...
        public LogoutButton()
        {
            ...
            FlatAppearance.MouseOverBackColor = _bgNormal;
            FlatAppearance.MouseDownBackColor = _bgNormal;
